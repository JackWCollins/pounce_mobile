...
RSpec.describe Api::V1::ShowingsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all showings as @showings" do
      ...
      expect(assigns(:showings)).to eq([showing])
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created showing as @showing" do
        post :create, {:showing => valid_attributes}, valid_session
        expect(assigns(:showing)).to be_a(Showing)
        expect(assigns(:showing)).to be_persisted
      end

      it "redirects to the created showing" do
        post :create, {:showing => valid_attributes}, valid_session
        expect(response).to redirect_to(Showing.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved showing as @showing" do
        post :create, {:showing => invalid_attributes}, valid_session
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested showing" do
        showing = Showing.create! valid_attributes
        put :update, {:id => showing.to_param, :showing => new_attributes}, valid_session
        showing.reload
      ...
      it "redirects to the showing" do
        showing = Showing.create! valid_attributes
        put :update, {:id => showing.to_param, :showing => valid_attributes}, valid_session
        expect(response).to redirect_to(showing)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the showing as @showing" do
        showing = Showing.create! valid_attributes
        put :update, {:id => showing.to_param, :showing => invalid_attributes}, valid_session
        expect(assigns(:showing)).to eq(showing)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the showings list" do
      showing = Showing.create! valid_attributes
      delete :destroy, {:id => showing.to_param}, valid_session
      expect(response).to redirect_to(showings_url)
    end
  end
